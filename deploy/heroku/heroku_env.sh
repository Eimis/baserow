...
export FROM_EMAIL="no-reply@${MAILGUN_DOMAIN:-mailhog}"

export EMAIL_SMTP_HOST=${MAILGUN_SMTP_SERVER:-mailhog}
export EMAIL_SMTP_PORT=${MAILGUN_SMTP_PORT:-1025}
export EMAIL_SMTP_USER=${MAILGUN_SMTP_LOGIN:-mailhog}
export EMAIL_SMTP_PASSWORD=${MAILGUN_SMTP_PASSWORD:-mailhog}
